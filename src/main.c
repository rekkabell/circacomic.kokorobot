...
char *html_characters = "<div><img src='../media/content/yegon.png' class='characters'><img src='../media/content/seir.png' class='characters'><img src='../media/content/adelie.png' class='characters'><img src='../media/content/caleb.png' class='characters'><img src='../media/content/nemerald.png' class='characters'><img src='../media/content/sy.png' class='characters'></div>";
